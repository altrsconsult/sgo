# Plano de Migração Iframe 4.5.0

- [x] Criar branch dedicada da migração `feat/iframe-core-v4.5.0`
- [x] Migrar o `ModuleViewerPage` para carregamento iframe-only
- [x] Preservar comportamento visual/layout atual do container do módulo
